...
//get data for table for first
		...
		//get data for table for first
		loadData(0,4,false,"",null,null,null);
		//get data for table
		function loadData(page,status,search,key,createAt,startDate,endDate) {
			var table = "#history-order-table tbody";
	...
	searchButton.addEventListener("click", function() {
	  ...
	  loadData(0,4,search,key,dateValue,startDateValue,endDateValue);
	});
	...
	function updateStatus(event){
		...
		$.ajax({
	      ...
	      success: function() {
	        ...
	        loadData(currentPageForEditAndDelete,4);
